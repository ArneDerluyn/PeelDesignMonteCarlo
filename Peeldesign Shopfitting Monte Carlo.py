...
class Case:
    ...
    def plot_cost_breakdown_per_loop(cases, show=True, **cost_inputs):
        ...
        ax.set_title("Shopfitting cost per loop by case")
...
d = Case("B", storage_months=3, transport_amount=2, coating_internal=True, peelcoating_price=2.3375) #Shopfitting as a service, coating internal
...
inputs = ["storage","transport_cost","coating_cost","decoating_time", "peelcoating_time"]
...
def save_monte_carlo_results(df, case_names, inputs, output_dir="monte_carlo_output"):
    ...
    results_file = output_dir / "shopfitting_monte_carlo_results.csv"
    summary_file = output_dir / "shopfitting_monte_carlo_summary.json"
